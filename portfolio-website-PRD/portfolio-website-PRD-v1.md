...
| Sexual Health Awareness | Project page | This is a project page walking though the steps of this project. It includes an media carousel, images and videos throughout.  |
| Every Drop Counts | Project page | This is a project page walking though the steps of this project. It includes a vertical image carousel. |
...
| Mental Health Awareness | Project page | This is a project page walking though the steps of this project. It includes images and videos throughout.  |
...
Page: sexual-health-awareness.html
...
- Per-project external content links (e.g. client-posted videos on YouTube/Facebook/etc.) — these will vary by project page, so should open in a new tab and be clearly styled as external links
    ...
    | sexual-health-awareness.html | live action film for campaign - english | [http://youtube.com/watch?v=EP_WHidwXSY](http://youtube.com/watch?v=EP_WHidwXSY) |
    | sexual-health-awareness.html | live action film for campaign - french | [https://www.youtube.com/watch?v=wBsIrQxuzkg](https://www.youtube.com/watch?v=wBsIrQxuzkg) |
